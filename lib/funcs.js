// Takes in a position, represented as either:
//  - 1 parameter i
//  - 1 parameter [x, y]
//  - 2 parameters x, y
// and returns the position represented as an index
function toi() {
    if (arguments.length == 2) {
        return arguments[1]*MAP_WIDTH + arguments[0];
...
//  - 1 parameter [x, y]
//  - 2 parameters x, y
// and returns the position represented as [x, y]
function toxy() {
    if (arguments.length == 2) {
        ...
        const x = arguments[0] % MAP_WIDTH;
        const y = Math.floor(arguments[0] / MAP_WIDTH);
        return [x, y];
    }
}
