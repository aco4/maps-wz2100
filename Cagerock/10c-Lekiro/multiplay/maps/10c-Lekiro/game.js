...
const CliffMap = new Map([
    [0b1010, Texture.CLIFF2 | 0 * TILE_ROT],
    [0b0101, Texture.CLIFF2 | 1 * TILE_ROT],
    [0b0110, Texture.CORNER_CLIFF2 | 0 * TILE_ROT],
    [0b0011, Texture.CORNER_CLIFF2 | 1 * TILE_ROT],
    [0b1001, Texture.CORNER_CLIFF2 | 2 * TILE_ROT],
    [0b1100, Texture.CORNER_CLIFF2 | 3 * TILE_ROT]
]);
